          ...
          <div className="lg:col-span-2">
            ...
            <div className="mt-10 grid grid-cols-1 gap-6 sm:grid-cols-3">
              ...
              <div className="rounded-xl bg-white p-6 text-center ">
                ...
                <p className="mt-2 text-gray-600">Placement</p>
              </div>
            </div>
          </div>
          ...
          <div className="rounded-2xl bg-white p-8 ">
            ...
            <div className="space-y-4">
              {[
                ...
                "PSO-02	Make use of management tools, optimization and leadership techniques to complete the computer engineering projects within stipulated time and funds.",
                "PSO-03	Contribute to the society for sustainable development through environmental awareness and upholding professional ethics."
 ...
 <div className="rounded-2xl bg-white p-8 ">
            ...
            <div className="space-y-4">
              {[
                ...
                "PEO2	To prepare the graduates to work as committed professionals with strong professional ethics and values, sense of responsibilities, understanding of legal, safety, health, societal, cultural and environmental issues.",
  ...
  "PO-3: Design/Development of Solutions - Design solutions for complex engineering problems and design system components or processes that meet the specified needs with appropriate consideration for public health, safety, cultural, societal, and environmental factors.",
  ...
  "PO-7: Environment and Sustainability - Understand the impact of professional engineering solutions in societal and environmental contexts and demonstrate the knowledge of sustainable development.",
  ...
  "PO-10: Communication - Communicate effectively on complex engineering activities with the engineering community and society at large through reports, presentations, documentation, and clear instructions.",

  "PO-11: Project Management and Finance - Demonstrate knowledge and understanding of engineering and management principles and apply these to manage projects and work effectively in multidisciplinary environments.",
